        ...
        <div className="relative w-full max-w-lg rounded-2xl border border-slate-200 bg-white shadow-xl">
          <div className="flex items-start justify-between gap-3 border-b border-slate-100 p-4">
            ...
            <button
              ...
              type="button"
              onClick={onClose}
              className="cursor-pointer rounded-full bg-white p-2 text-sm font-semibold text-slate-700 hover:bg-slate-100 focus:ring-2 focus:ring-indigo-200 focus:outline-none"
            >
              <X className="h-4 w-4" />
            </button>
          </div>
