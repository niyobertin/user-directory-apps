      ...
      <div className="rounded-xl border border-rose-200 bg-rose-50 p-4">
        ...
        {onRetry && (
          <button
            type="button"
            onClick={onRetry}
            className="mt-3 rounded-lg bg-rose-600 px-3 py-2 text-sm font-medium text-white shadow-sm hover:bg-rose-700 focus:ring-2 focus:ring-rose-200 focus:outline-none"
          >
            Retry
          </button>
        )}
