...
const UserSearchEmptyState = ({ searchTerm, onClear }: UserSearchEmptyStateProps) => {
    return (
        <div style={{
            ...
            <p style={{ margin: "0 0 24px", fontSize: 14, color: "#6b7280", maxWidth: 280, lineHeight: 1.6 }}>
                {searchTerm
                    ? <>No results for <strong style={{ color: "#374151" }}>"{searchTerm}"</strong>. Try a different name.</>
